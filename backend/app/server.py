...
from app.api.services.startup_service import (
...
app = FastAPI(
    ...
    description="Trading platform with real-time order matching",
    version="1.0.0",
...
app.include_router(
    order_router, prefix="/api/v1/orders", tags=["Orders & Trading"]
)

app.include_router(ws_router, prefix="/api/v1/ws", tags=["websocket"])

app.include_router(price_router, prefix="/api/v1/prices", tags=["Price"])
