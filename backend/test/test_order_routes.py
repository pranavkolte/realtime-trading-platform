...
def override_dependencies(mock_user, mock_admin, mock_db, mock_order_service, mock_ws_manager):
    from app.api.routers import order_routers
    app.dependency_overrides = {}
    app.dependency_overrides[order_routers.get_current_user] = lambda: mock_user
    app.dependency_overrides[order_routers.get_current_admin_user] = lambda: mock_admin
...
async def test_cancel_order_success(mock_order_service, mock_ws_manager):
    ...
    mock_order_service.get_order_book_snapshot.return_value.dict.return_value = {"bids": [], "asks": []}
